# Table: `dbo.DeletedAutoDependencies`
...
|------|--------|------|---------|----------|
| `IX_DeletedAutoDependencies_ChildUri` | no | NONCLUSTERED | `ChildUri` |  |
| `IX_DeletedAutoDependencies_DependencyId` | YES | CLUSTERED | `DependencyId` |  |
