# View: `dbo.VoipICMPPathMonthReport`
...
```sql
CREATE VIEW [dbo].[VoipICMPPathMonthReport]
AS
...
(
SELECT TOP 20000
	CONVERT(DateTime, LTRIM(MONTH(DateTime)) + '/01/' + LTRIM(YEAR(DateTime)), 101) AS SummaryDate,
