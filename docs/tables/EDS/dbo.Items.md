...
| `IX_Items_ActiveListPrice_API` | no | NONCLUSTERED | `Active`, `ListPrice` | `ItemId`, `Description`, `VendorId`, `CategoryId`, `UnitId`, `VendorPartNumber`, `ItemCode` |
| `IX_Items_Description_API` | no | NONCLUSTERED | `Description` | `ItemId`, `VendorId`, `CategoryId`, `ListPrice` |
| `IX_Items_ProductList_API` | no | NONCLUSTERED | `Active`, `ListPrice`, `Description` | `ItemId`, `VendorId`, `CategoryId`, `UnitId`, `VendorPartNumber`, `ShortDescription`, `ItemCode` |
