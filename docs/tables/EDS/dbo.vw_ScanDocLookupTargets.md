# View: `dbo.vw_ScanDocLookupTargets`
...
```sql
CREATE view [dbo].[vw_ScanDocLookupTargets] as
select sj.ScanJobId, DocTypeFieldExternalLookup.Id DocTypeFieldExternalLookupId, DocTypeFieldExternalLookup.ExternalTableName, DocTypeFieldExternalLookup.ItemOrder, DocTypeFieldExternalLookupSelectItem.Id DocTypeFieldExternalLookupItemId, DocTypeFieldExternalLookupSelectItem.ItemOrder DocTypeFieldExternalLookupItemOrder, DocTypeFieldExternalLookupSelectItem.ExternalValueColumn, DocTypeField.Name, DocTypeField.Id DocTypeFieldId
  ...
  join ContentCentral.dbo.DocTypeFieldExternalLookupSelectItem DocTypeFieldExternalLookupSelectItem on DocTypeFieldExternalLookupSelectItem.DocTypeFieldExternalLookupId = DocTypeFieldExternalLookup.Id
