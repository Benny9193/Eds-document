...
Per-(`BudgetId`, district) annual savings rollup (~11K rows). Wide reporting row totalling bid / catalog / state-contract costs and savings, included vs. excluded buckets, and overall percent savings / discount. Output of the annual savings calculation; consumed by reporting.
