# Table: `dbo.Reqsb4Update_021320202`
...
| 41 | `UseAllocations` | tinyint | YES |  |  |
| 42 | `AllocationAvailable` | money | YES |  |  |
| 43 | `AmountAvailable` | money | YES |  |  |
...
|------|--------|------|---------|----------|
| `PK_Requisitions` | YES | CLUSTERED | `RequisitionId` |  |
