...
| 30 | `closeoutAllPayrollsVerified` | bit | NO | `((0))` |  |
| 31 | `closeoutCertifiedAt` | datetime2 | YES |  |  |
| 32 | `closeoutCertifiedByName` | nvarchar(1000) | YES |  |  |
| 33 | `closeoutCertifiedByTitle` | nvarchar(1000) | YES |  |  |
| 34 | `closeoutDocumentsReceived` | bit | NO | `((0))` |  |
| 35 | `closeoutInspectionComplete` | bit | NO | `((0))` |  |
| 36 | `closeoutStatus` | nvarchar(1000) | YES |  |  |
| 37 | `closeoutSubPayrollsVerified` | bit | NO | `((0))` |  |
| 38 | `fundCertificationDate` | datetime2 | YES |  |  |
| 39 | `fundCertifiedByName` | nvarchar(1000) | YES |  |  |
| 40 | `fundCertifiedByTitle` | nvarchar(1000) | YES |  |  |
| 41 | `miniCompExceptionCategory` | nvarchar(1000) | YES |  |  |
| 42 | `miniCompExceptionJustification` | nvarchar(max) | YES |  |  |
| 43 | `priceChallengeAwardAction` | nvarchar(1000) | YES |  |  |
| 44 | `priceChallengeCriterion` | nvarchar(1000) | YES |  |  |
| 45 | `priceChallengeDate` | datetime2 | YES |  |  |
| 46 | `priceChallengeIceDateCreated` | datetime2 | YES |  |  |
| 47 | `priceChallengeIceDocumentKey` | nvarchar(1000) | YES |  |  |
| 48 | `priceChallengeInvoked` | bit | NO | `((0))` |  |
| 49 | `priceChallengeJustification` | nvarchar(max) | YES |  |  |
| 50 | `priceChallengeNoticeSentAt` | datetime2 | YES |  |  |
| 51 | `priceChallengeRevisionDeadline` | datetime2 | YES |  |  |
| 52 | `primaryRevisedBoeDocumentKey` | nvarchar(1000) | YES |  |  |
| 53 | `primaryRevisedPrice` | decimal(18,2) | YES |  |  |
| 54 | `secondaryBoeDocumentKey` | nvarchar(1000) | YES |  |  |
| 55 | `secondaryProposalPrice` | decimal(18,2) | YES |  |  |
| 56 | `secondaryTorIssuedAt` | datetime2 | YES |  |  |
| 57 | `aeTriggerCode` | nvarchar(1000) | YES |  |  |
| 58 | `aeTriggerCodeOther` | nvarchar(1000) | YES |  |  |
| 59 | `hasProfessionalDocumentation` | bit | NO | `((0))` |  |
| 60 | `maintenanceTradeDetermination` | nvarchar(max) | YES |  |  |
| 61 | `maintenanceTradeDocumentKey` | nvarchar(1000) | YES |  |  |
| 62 | `professionalDocFlaggedForReview` | bit | NO | `((0))` |  |
| 63 | `professionalDocReference` | nvarchar(1000) | YES |  |  |
| 64 | `professionalDocReviewedAt` | datetime2 | YES |  |  |
| 65 | `professionalDocReviewedById` | nvarchar(1000) | YES |  |  |
