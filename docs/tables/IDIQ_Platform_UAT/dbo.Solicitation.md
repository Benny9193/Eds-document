...
| 28 | `awardDate` | datetime2 | YES |  |  |
| 29 | `createdById` | nvarchar(1000) | NO |  |  |
| 30 | `createdAt` | datetime2 | NO | `(getdate())` |  |
| 31 | `updatedAt` | datetime2 | NO |  |  |
| 32 | `priceWeight` | int | NO | `((50))` |  |
| 33 | `qualificationsWeight` | int | NO | `((50))` |  |
| 34 | `referencesWeight` | int | NO | `((0))` |  |
| 35 | `dueTime` | nvarchar(1000) | NO | `('14:00')` |  |
