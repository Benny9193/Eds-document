# View: `dbo.vw_BidTradesBySession`
...
```sql
CREATE   view  [dbo].[vw_BidTradesBySession] as
select SessionTable.SessionId, Trades.Description, BidTrades.Title TradeTitle, /*Trades.PackageNumber*/ 0 PackageNumber, BidTradeCounties.BidTradeCountyId, BidHeaders.BidDate, BidHeaders.BidAwardDate, BidHeaders.EffectiveFrom, BidHeaders.EffectiveUntil, BidHeaders.BidHeaderId, coalesce(Trades.pwRequired,0) pwRequired
