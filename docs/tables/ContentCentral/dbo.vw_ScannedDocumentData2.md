# View: `dbo.vw_ScannedDocumentData2`
...
```sql
CREATE view [dbo].[vw_ScannedDocumentData2] as
select Catalog.Name CatalogName, 
  ...
  join DocTypeField dtf2 on dtf2.DocTypeId = DocType.Id
                        and dtf2.Name = 'Vendor Code*'
  join DocumentField df2 on df2.DocumentId = Document.Id
                        and df2.DocTypeFieldId = dtf2.Id
  join DocTypeField dtf3 on dtf3.DocTypeId = DocType.Id
                        and dtf3.Name = 'Vendor Bid Document Type'
