...
|-------|------|-------------|
| [`dbo.bidcalendar`](dbo.bidcalendar.md) | 6720 |  |
| [`dbo.bidcalendaritems`](dbo.bidcalendaritems.md) | 1664090 |  |
| [`dbo.biddocumentacks`](dbo.biddocumentacks.md) | 18 |  |
| [`dbo.BidDocumentLog`](dbo.BidDocumentLog.md) | 26 |  |
| [`dbo.biddocuments`](dbo.biddocuments.md) | 175741 |  |
| [`dbo.BidManagers`](dbo.BidManagers.md) | 0 |  |
| [`dbo.BidSchedule`](dbo.BidSchedule.md) | 1633 |  |
| [`dbo.BidScheduleCats`](dbo.BidScheduleCats.md) | 3111 |  |
| [`dbo.Categories`](dbo.Categories.md) | 63 |  |
| [`dbo.Cooperatives`](dbo.Cooperatives.md) | 15 |  |
| [`dbo.debugmsgs`](dbo.debugmsgs.md) | 58535 |  |
| [`dbo.DocumentUploads`](dbo.DocumentUploads.md) | 144898 |  |
| [`dbo.DownloadLog`](dbo.DownloadLog.md) | 426087 |  |
| [`dbo.dtproperties`](dbo.dtproperties.md) | 7 |  |
| [`dbo.ledger`](dbo.ledger.md) | 0 |  |
| [`dbo.Regcalendar`](dbo.Regcalendar.md) | 631808 |  |
| [`dbo.regcalsaved`](dbo.regcalsaved.md) | 998 |  |
| [`dbo.registrations`](dbo.registrations.md) | 14207 |  |
| [`dbo.regusers`](dbo.regusers.md) | 13383 |  |
...
| [`dbo.TransmitLog`](dbo.TransmitLog.md) | 5880 |  |
...
| [`dbo.vendorbiditems`](dbo.vendorbiditems.md) | 24495480 |  |
| [`dbo.vendorbiditems_Orig`](dbo.vendorbiditems_Orig.md) | 20031681 |  |
| [`dbo.vendorbiditemsjournal`](dbo.vendorbiditemsjournal.md) | 5300470 |  |
| [`dbo.VendorBidMSRPPriceRanges`](dbo.VendorBidMSRPPriceRanges.md) | 537578 |  |
| [`dbo.VendorBidMSRPResults`](dbo.VendorBidMSRPResults.md) | 141573 |  |
| [`dbo.VendorBidMSRPResultsJournal`](dbo.VendorBidMSRPResultsJournal.md) | 141023 |  |
| [`dbo.vendorbids`](dbo.vendorbids.md) | 59579 |  |
| [`dbo.vendorbidsjournal`](dbo.vendorbidsjournal.md) | 59741 |  |
| [`dbo.VendorBidTMAnswers`](dbo.VendorBidTMAnswers.md) | 695835 |  |
| [`dbo.VendorBidTMAnswersJournal`](dbo.VendorBidTMAnswersJournal.md) | 695859 |  |
| [`dbo.VendorEmailLog`](dbo.VendorEmailLog.md) | 804590 |  |
| [`dbo.vendorsessions`](dbo.vendorsessions.md) | 61011 |  |
...
erDiagram
    ...
    dbo_trantypes {
        int trantypeid PK,FK
    }
    dbo_vendorbiditems_Orig {
        int vendorbiditemid PK,FK
        int vendorbidid FK
    }
    dbo_vendorbiditemsjournal {
        int vbijid PK
        int vendorbiditemid FK
        int sessionid FK
    }
    dbo_vendorbids {
        int vendorbidid PK,FK
        int registrationid FK
        int calendarid FK
    }
    dbo_vendorbidsjournal {
        int vbjid PK
        int vendorbidid FK
        int sessionid FK
    }
    ...
    dbo_bidcalendar ||--o{ dbo_ledger : "FK_BidLedger_BidCalendar"
    dbo_registrations ||--o{ dbo_ledger : "FK_BidLedger_Registrations"
    dbo_trantypes ||--o{ dbo_ledger : "FK_BidLedger_TranTypes"
    dbo_vendorbids ||--o{ dbo_vendorbiditems_Orig : "FK_VendorBidItems_VendorBids"
    dbo_vendorbiditems_Orig ||--o{ dbo_vendorbiditemsjournal : "FK_VendorBidItemsJournal_VendorBidItems"
    dbo_vendorsessions ||--o{ dbo_vendorbiditemsjournal : "FK_VendorBidItemsJournal_VendorSessions"
    dbo_bidcalendar ||--o{ dbo_vendorbids : "FK_VendorBids_BidCalendar"
    dbo_registrations ||--o{ dbo_vendorbids : "FK_VendorBids_Registrations"
    dbo_vendorbids ||--o{ dbo_vendorbidsjournal : "FK_VendorBidsJournal_VendorBids"
    dbo_vendorsessions ||--o{ dbo_vendorbidsjournal : "FK_VendorBidsJournal_VendorSessions"
    dbo_registrations ||--o{ dbo_vendorsessions : "FK_VendorSessions_Registrations"
```
