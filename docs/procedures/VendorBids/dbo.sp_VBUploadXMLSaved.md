# Procedure: `dbo.sp_VBUploadXMLSaved`
...
|----------|-------|
| Schema | `dbo` |
| Name | `sp_VBUploadXMLSaved` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2013-10-17 15:55:44 |
...
-- =============================================
create PROCEDURE [dbo].[sp_VBUploadXMLSaved]
			...
			begin
			  insert into VendorBidMSRPResults (VendorBidId, BidRequestManufacturerId, ManufacturerName, WriteInManufacturer, PriceListType, BidRequestProductLineId, ProductLineName, WriteInProductLine, BidRequestOptionId, OptionName)
			    select VendorBids.vendorbidid, x.BidRequestManufacturerId, x.ManufacturerName, x.WriteInManufacturer, x.PriceListType, x.BidRequestProductLineId, x.ProductLineName, x.WriteInProductLine, x.BidRequestOptionId, x.OptionName
 				  from OPENXML(@hDoc, '/BidResults/MSRPManufacturers/MSRPManufacturer') 
				  with (BidRequestManufacturerId varchar(50) 'BidRequestManufacturerId',
						...
						BidRequestProductLineId varchar(512) 'ProductLinesWithOptions/ProductLine/BidRequestProductLineId',
						ProductLineName varchar(512) 'ProductLinesWithOptions/ProductLine/ProductLineName',
						WriteInProductLine varchar(512) 'ProductLinesWithOptions/ProductLine/ProductLineWriteIn',
						BidRequestOptionId varchar(512) 'ProductLinesWithOptions/ProductLine/Option/BidRequestOptionId',
						OptionName varchar(512) 'ProductLinesWithOptions/ProductLine/Option/OptionName') x
				   join vendorbids on VendorBids.vendorbidid = @VendorBidId
			  ...
			  insert into VendorBidMSRPResultsJournal (VendorBidMSRPResultsId, SessionId, WeightedDiscount)
			    select VendorBidMSRPResults.VendorBidMSRPResultsId, @SessionId, EncryptByPassPhrase(@pPassPhrase, x.WeightedDiscount, 1, cast(VendorBidMSRPResults.VendorBidMSRPResultsId as varbinary))
				  ...
				  with (BidRequestManufacturerId varchar(50) 'BidRequestManufacturerId',
						...
						WriteInProductLine varchar(512) 'ProductLinesWithOptions/ProductLine/ProductLineWriteIn',
						BidRequestOptionId varchar(512) 'ProductLinesWithOptions/ProductLine/Option/BidRequestOptionId',
						OptionName varchar(512) 'ProductLinesWithOptions/ProductLine/Option/OptionName',
						WeightedDiscount varchar(512) 'ProductLinesWithOptions/ProductLine/Option/PriceRanges/AvgWeightedDiscount') x
				   join vendorbids on VendorBids.vendorbidid = @VendorBidId
