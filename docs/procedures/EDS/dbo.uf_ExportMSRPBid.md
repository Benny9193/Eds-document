...
_Generated on 2026-05-04T13:43:19.007Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_ExportMSRPBid` |
| Kind | Function (table-valued) |
| sys.objects.type | `TF` (SQL_TABLE_VALUED_FUNCTION) |
| Created | 2014-07-16 15:05:03 |
| Modified | 2014-07-16 15:05:03 |
| Encrypted | no |
...
```sql
create function [dbo].[uf_ExportMSRPBid] (@BidHeaderId int)
returns @ExportSet table (ManufacturerName varchar(50), ProductLine varchar(50), OptionName varchar(50), RangeBase1 varchar(50), RangeWeight1 varchar(50), RangeBase2 varchar(50), RangeWeight2 varchar(50), RangeBase3 varchar(50), RangeWeight3 varchar(50), RangeBase4 varchar(50), RangeWeight4 varchar(50), RangeBase5 varchar(50), RangeWeight5 varchar(50), RangeBase6 varchar(50), RangeWeight6 varchar(50))
as
begin
