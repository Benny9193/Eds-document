# Function: table-valued: `dbo.uf_RequisitionListTest`

_Generated on 2026-05-04T14:49:07.414Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_RequisitionListTest` |
| Kind | Function (table-valued) |
| sys.objects.type | `TF` (SQL_TABLE_VALUED_FUNCTION) |
| Created | 2008-06-20 11:36:39 |
...
```sql
CREATE function dbo.uf_RequisitionListTest (@pSessionId int, @pCategoryId int, @pBudgetId int, @pAccountId int, @pSchoolId int, @pUserId int, @pStatusId int)
...
update @@PendingApprovals
   set LastApproverId = Users.UserId,
       NextApproverId = Users.ApproverId
