# Procedure: `dbo.sp_CCUpdateUserAccountsBulk`

_Generated on 2026-05-04T13:07:57.384Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `sp_CCUpdateUserAccountsBulk` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2004-02-19 00:44:20 |
...
|---|------|------|------|---------|
| 1 | `@pActive` | IN | int |  |
| 2 | `@pCometId` | IN | varchar(255) |  |
| 3 | `@pUserName` | IN | varchar(255) |  |
| 4 | `@pPassword` | IN | varchar(255) |  |
| 5 | `@pAttention` | IN | varchar(255) |  |
| 6 | `@pUseAllocations` | IN | int |  |
| 7 | `@pCode` | IN | varchar(255) |  |
| 8 | `@pAllocationAmount` | IN | money |  |
| 9 | `@pDistrictId` | IN | int |  |
| 10 | `@pUserId` | IN | int |  |
| 11 | `@pUserAccountId` | IN | int |  |
| 12 | `@pSchoolId` | IN | int |  |
| 13 | `@pDelete` | IN | int |  |
| 14 | `@pDistrictAccountingCode` | IN | varchar(255) |  |
...
```sql
CREATE procedure [dbo].[sp_CCUpdateUserAccountsBulk] @pActive int, @pCometId varchar(255), @pUserName varchar(255), @pPassword varchar(255), @pAttention varchar(255), @pUseAllocations int, @pCode varchar(255), @pAllocationAmount money, @pDistrictId int, @pUserId int, @pUserAccountId int, @pSchoolId int, @pDelete int, @pDistrictAccountingCode varchar(255) as
