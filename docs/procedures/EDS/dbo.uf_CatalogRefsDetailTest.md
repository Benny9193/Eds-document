# Function: scalar: `dbo.uf_CatalogRefsDetailTest`

_Generated on 2026-05-04T14:49:07.358Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_CatalogRefsDetailTest` |
| Kind | Function (scalar) |
| sys.objects.type | `FN` (SQL_SCALAR_FUNCTION) |
| Created | 2017-04-17 12:29:23 |
| Modified | 2017-04-17 12:29:23 |
| Encrypted | no |
...
create function [dbo].[uf_CatalogRefsDetailTest] (@pDetailId int)
returns varchar(8000)
