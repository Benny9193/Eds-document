# Function: table-valued: `dbo.uf_LookupItemCodeByReqVendor_BK20241227`

_Generated on 2026-05-04T13:43:19.030Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_LookupItemCodeByReqVendor_BK20241227` |
| Kind | Function (table-valued) |
| sys.objects.type | `TF` (SQL_TABLE_VALUED_FUNCTION) |
| Created | 2024-12-27 01:54:30 |
| Modified | 2024-12-27 01:54:30 |
| Encrypted | no |
...
CREATE function dbo.uf_LookupItemCodeByReqVendor_BK20241227 (@pRequisitionId int, @pItemCode varchar(255), @pVendorId int)
