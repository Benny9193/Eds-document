# Procedure: `dbo.sp_NewRequisitionId`

_Generated on 2026-05-04T13:07:57.492Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `sp_NewRequisitionId` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2001-09-06 23:26:02 |
| Modified | 2025-06-26 11:50:16 |
| Encrypted | no |
...
| Caller | Type |
|--------|------|
| `null.sp_CopyReq` | SQL_STORED_PROCEDURE |
| `dbo.sp_CopyReqBulk` | SQL_STORED_PROCEDURE |
| `dbo.usp_CopyRequisition` | SQL_STORED_PROCEDURE |

## Definition

```sql
CREATE procedure [dbo].[sp_NewRequisitionId] @pDistrictId int, @pSchoolId int, @pBudgetId int, @pUserId int, @ReqId int output AS
