...
_Generated on 2026-05-04T13:43:18.982Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_ContactListHtml` |
| Kind | Function (scalar) |
| sys.objects.type | `FN` (SQL_SCALAR_FUNCTION) |
| Created | 2012-01-17 00:22:40 |
| Modified | 2012-01-17 00:22:40 |
| Encrypted | no |
| Returns | varchar(max) |
...
```sql
create function dbo.uf_ContactListHtml (@DistrictId int)
returns varchar(max)
as
begin
