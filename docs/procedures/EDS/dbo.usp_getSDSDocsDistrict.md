...
_Generated on 2026-05-04T13:04:00.719Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `usp_getSDSDocsDistrict` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2022-09-14 16:57:36 |
| Modified | 2022-09-14 18:35:48 |
| Encrypted | no |
...
CREATE   procedure [dbo].[usp_getSDSDocsDistrict] @DistrictId int
as
begin
