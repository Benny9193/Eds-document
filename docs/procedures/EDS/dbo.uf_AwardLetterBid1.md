# Function: table-valued: `dbo.uf_AwardLetterBid1`

_Generated on 2026-05-04T13:43:18.953Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_AwardLetterBid1` |
| Kind | Function (table-valued) |
| sys.objects.type | `TF` (SQL_TABLE_VALUED_FUNCTION) |
| Created | 2011-02-25 11:05:01 |
| Modified | 2011-02-25 11:05:01 |
| Encrypted | no |
...
create function [dbo].[uf_AwardLetterBid1] (@pRSId int, @pCategoryId int, @pBidHeaderId int)
...
begin
  ...
  insert @BidsTable (RSId, DistrictId, CategoryId, PricePlanId, VendorId, ItemsBid, AmountBid, BidDate, BidAwardDate, BidHeaderId)
    select @pRSId, ds.DistrictId, ds.CategoryId, ds.PricePlanId, BidImports.VendorId, BidImports.ItemsBid, 
                    BidImports.AmountBid, BidHeaders.BidDate, BidHeaders.BidAwardDate, BidHeaders.BidHeaderId
      from dbo.uf_DistrictSummaryBid(@pRSId, @pCategoryId, @pBidHeaderId) ds
      join dbo.BidHeaders on BidHeaders.BidHeaderId = ds.BidHeaderId
