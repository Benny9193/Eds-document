# Function: scalar: `dbo.uf_VendorContacts`

_Generated on 2026-05-04T14:49:07.440Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_VendorContacts` |
| Kind | Function (scalar) |
| sys.objects.type | `FN` (SQL_SCALAR_FUNCTION) |
| Created | 2011-08-25 11:28:19 |
| Modified | 2011-08-25 14:04:06 |
| Encrypted | no |
| Returns | varchar(max) |
...
CREATE function uf_VendorContacts(@VendorId int)
