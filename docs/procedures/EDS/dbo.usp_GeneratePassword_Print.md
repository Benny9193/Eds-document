# Procedure: `dbo.usp_GeneratePassword_Print`

_Generated on 2026-05-04T13:04:00.707Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `usp_GeneratePassword_Print` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2025-01-03 09:17:08 |
| Modified | 2025-01-03 09:17:08 |
| Encrypted | no |
...
```sql
create   procedure [dbo].[usp_GeneratePassword_Print] @pUserId int, @pLength int
as
begin
set NOCOUNT on
...
select @pUserId, @CometId, @NewPass 
Update Users
