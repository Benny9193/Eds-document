# Procedure: `dbo.sp_BidCopyChangePP`

_Generated on 2026-05-04T14:49:07.217Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `sp_BidCopyChangePP` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2010-09-15 23:02:40 |
| Modified | 2025-12-04 15:15:56 |
| Encrypted | no |
...
```sql
CREATE   procedure [dbo].[sp_BidCopyChangePP] @pSourceBidId int, @pNewPPId int, @pCopies int as
set transaction isolation level read uncommitted
declare @BidHeaderId int, @BidImportId int, @NewBidImportId int, @LoopCounter int, @SourceBidHeaderId int, @TargetPricePlanId int, @BidHeaderKey int

begin Transaction
set nocount on
select @TargetPricePlanId = @pNewPPId
select @SourceBidHeaderId = @pSourceBidId
select @LoopCounter = 0
while @LoopCounter < @pCopies
begin
  select @LoopCounter = @LoopCounter + 1

insert BidHeaders (Active, CategoryId, PricePlanId, BidDate, BidAwardDate, BidMessage, BidType, PriceVarianceLevel, MinimumPOAmount, Section, BudgetYearOption, EffectiveFrom, EffectiveUntil, Description, AllowTotalAward, TotalAwardMinimumDiscount, CalendarId, StateId, HostDistrictId, AwardMsg, AlertLink, AlertMsg, BidManagerId, CompliantAlert, HostAwardDate, AllowAdditionalManufacturers, AllowAdditionalProductLines, UseOptions, ImageURLRuleset, ReadyToUseDate, DateCreated)
  select Active, CategoryId, @TargetPricePlanId, BidDate, BidAwardDate, BidMessage, BidType, PriceVarianceLevel, MinimumPOAmount, Section, BudgetYearOption, EffectiveFrom, EffectiveUntil, Description, AllowTotalAward, TotalAwardMinimumDiscount, CalendarId, StateId, HostDistrictId, AwardMsg, AlertLink, AlertMsg, BidManagerId, CompliantAlert, HostAwardDate, AllowAdditionalManufacturers, AllowAdditionalProductLines, UseOptions, ImageURLRuleset, ReadyToUseDate, DateCreated
    from BidHeaders
...
begin
  ...
  insert BidHeaderDetail (BidHeaderKey, BidHeaderId, DetailId, Quantity, BidRequestItemId)
  select @BidHeaderKey, @BidHeaderId, BidHeaderDetail.DetailId, BidHeaderDetail.Quantity, @NewBidRequestItemId -- added quantity 4/3/2018 kjm
    from BidHeaderDetail
...
begin
  ...
  insert BidImports (BidImportId, BidheaderKey, BidHeaderId, Active, VendorId, BidItemDiscountRate, CatalogId, CatalogDiscountRate, VendorBidNumber, ItemsBid, AmountBid, Status, Comments, AdditionalHandlingAmount, BidVendorContactId, CatalogDiscountComments, ContactEmail, ContactFax, ContactName, ContactPhone, FreeDeliveryMinimum, FreeHandlingAmount, FreeHandlingEnd, FreeHandlingStart, MinimumOrder, POVendorContactId)
...
-- ============================ Begin new code Part B ==================================
  insert BidResults (BidImportId, BidHeaderKey, BidHeaderId, BidRequestItemId, CategoryId, DistrictId, ItemId, ItemCode, Units, Alternate, Quantity, ItemBidType, UnitPrice, Cost, VendorItemCode, QuantityBid, ItemsPerUnit, UnitId, Status, Comments, Active, PageNo, PackedVendorItemCode, RTK_MSDSId, RTK_MSDSNotNeeded, ContractNumber, OriginalAwardedItem, VOMId, AdditionalShipping, ManufacturerBid, ManufPartNoBid, LinerGaugeMicrons, LinerGaugeMil, LinerCaseWeight, LinerDimWidth, LinerDimDepth, LinerDimLength, PackedManufPartNoBid, SDS_URL, ImageURL, UPC_ISBN, UniqueItemNumber, DigitallyDelivered, MinimumOrderQuantity, PrescriptionRequired, PerishableItem, HashKey, ProductNames, TypeAheads, AIShortDesc, AIFullDesc, AIUNSPSC, AIDate)
    select @NewBidImportId, @BidHeaderKey, @BidHeaderId, #TempBRI.NewBidRequestItemId, BidResults.CategoryId, BidResults.DistrictId, BidResults.ItemId, BidResults.ItemCode, BidResults.Units, BidResults.Alternate, BidResults.Quantity, BidResults.ItemBidType, BidResults.UnitPrice, BidResults.Cost, BidResults.VendorItemCode, BidResults.QuantityBid, BidResults.ItemsPerUnit, BidResults.UnitId, BidResults.Status, BidResults.Comments, BidResults.Active, PageNo, PackedVendorItemCode, RTK_MSDSId, RTK_MSDSNotNeeded, ContractNumber, OriginalAwardedItem, VOMId, AdditionalShipping, ManufacturerBid, ManufPartNoBid, LinerGaugeMicrons, LinerGaugeMil, LinerCaseWeight, LinerDimWidth, LinerDimDepth, LinerDimLength, PackedManufPartNoBid, SDS_URL, ImageURL, UPC_ISBN, UniqueItemNumber, DigitallyDelivered, MinimumOrderQuantity, PrescriptionRequired, PerishableItem, HashKey, ProductNames, TypeAheads, AIShortDesc, AIFullDesc, AIUNSPSC, AIDate
      from BidResults
      join BidImports on BidImports.BidImportId = BidResults.BidImportId
