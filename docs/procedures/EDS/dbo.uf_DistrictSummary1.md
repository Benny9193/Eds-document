# Function: table-valued: `dbo.uf_DistrictSummary1`

_Generated on 2026-05-04T13:04:24.251Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_DistrictSummary1` |
| Kind | Function (table-valued) |
| sys.objects.type | `TF` (SQL_TABLE_VALUED_FUNCTION) |
| Created | 2006-05-31 10:27:44 |
| Modified | 2018-05-04 14:19:27 |
| Encrypted | no |
...
| Caller | Type |
|--------|------|
| `dbo.uf_AwardLetter1` | SQL_TABLE_VALUED_FUNCTION |
| `dbo.uf_DistrictSummaryVendors1` | SQL_TABLE_VALUED_FUNCTION |
| `dbo.uf_VendorSummary` | SQL_TABLE_VALUED_FUNCTION |

## Definition

```sql
CREATE      function [dbo].[uf_DistrictSummary1] (@pRSId int, @pCategoryId int)
