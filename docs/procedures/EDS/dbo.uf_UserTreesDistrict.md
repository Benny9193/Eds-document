...
_Generated on 2026-05-04T13:04:00.659Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_UserTreesDistrict` |
| Kind | Function (table-valued) |
| sys.objects.type | `TF` (SQL_TABLE_VALUED_FUNCTION) |
| Created | 2005-08-31 23:52:22 |
...
```sql
create function dbo.uf_UserTreesDistrict (@pRSId int, @pDistrictId int)
...
select Budgets.DistrictId from ReportSessionLinks join Budgets on Budgets.BudgetId = ReportSessionLinks.IntId where RSId = @pRSId and Budgets.DistrictId = @pDistrictId
