# Function: table-valued: `null.uf_LookupItemsForBatch`

_Generated on 2026-05-04T13:04:00.225Z_
...
```sql
CREATE    function EDSIQWebUser.uf_LookupItemsForBatch (@pEffectiveDate datetime, @pBatchId int)
