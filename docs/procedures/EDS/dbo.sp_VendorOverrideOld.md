# Procedure: `dbo.sp_VendorOverrideOld`

_Generated on 2026-05-04T14:49:07.341Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `sp_VendorOverrideOld` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2008-03-06 18:02:56 |
...
create procedure dbo.sp_VendorOverrideOld @pBidResultsId int, @pSessionId int, @pReason varchar(4096) as
