# Function: inline table-valued: `dbo.uf_BidItemWinnerReq`

_Generated on 2026-05-04T13:04:24.225Z_
...
```sql
create function dbo.uf_BidItemWinnerReq(@pBidHeaderId int, @pRequisitionId int)
returns table
as
