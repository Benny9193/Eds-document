...
_Generated on 2026-05-04T13:43:18.788Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `sp_CreatePOTest` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2024-06-27 18:20:41 |
| Modified | 2024-06-27 18:20:41 |
| Encrypted | no |
...
```sql
create   procedure [dbo].[sp_CreatePOTest] @pSessionId int, @pRequisitionId int AS
