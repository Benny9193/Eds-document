...
_Generated on 2026-05-04T13:07:57.652Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_LookupPriceByBH` |
| Kind | Function (table-valued) |
| sys.objects.type | `TF` (SQL_TABLE_VALUED_FUNCTION) |
| Created | 2006-09-16 14:16:12 |
| Modified | 2019-05-02 20:17:32 |
| Encrypted | no |
...
| `dbo.sp_UpdateDetails` | SQL_STORED_PROCEDURE |
| `dbo.uf_LookupPricesAlt` | SQL_TABLE_VALUED_FUNCTION |

## Definition

```sql
--select * from uf_LookupPriceByBH(3747617,8672)
CREATE   function [dbo].[uf_LookupPriceByBH] (@pItemId int, @pBidHeaderId int)
...
--    join vw_ItemDescription dd on dd.ItemId = it.ItemId
		left outer join vw_BidItemDescription vbid on isnull(vbid.BidHeaderId,0) = it.BidHeaderId
