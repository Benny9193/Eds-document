# Function: table-valued: `dbo.uf_LookupItemCodeByBH`

_Generated on 2026-05-04T13:04:24.269Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_LookupItemCodeByBH` |
| Kind | Function (table-valued) |
| sys.objects.type | `TF` (SQL_TABLE_VALUED_FUNCTION) |
| Created | 2006-11-13 08:25:09 |
...
CREATE   function dbo.uf_LookupItemCodeByBH (@pItemCode varchar(255), @pCategoryId int, @pCatalogId int, @pBidHeaderId int)
...
/*
  ...
  begin
    ...
    insert @ItemTable ([ItemId], [CrossRefId], [CrossRefIdBid], [BidPrice], [GrossPrice], [CatalogPrice], [AwardId], [VendorId], [PricePlanId], [CatalogId], [VendorItemCode], [Alternate], [BidItemId], [ParentCatalogId], [ItemCode], [Description], [UnitId], [UnitCode], [Page], [CatalogYear], [DiscountRate], [Name], [VendorName], [CategoryId], [PackedItemCode], [PackedVendorItemCode], ItemMustBeBid )
      select I1.ItemId, CrossRefs.CrossRefId, null, CrossRefs.GrossPrice, CrossRefs.GrossPrice, CrossRefs.CatalogPrice, null, null, @PricePlanId, CrossRefs.CatalogId, CrossRefs.VendorItemCode, null, null, I1.ParentCatalogId, I1.ItemCode, dbo.uf_ItemDescription(I1.ItemId), Units.UnitId, Units.Code, CrossRefs.Page, CrossRefs.CatalogYear, null, Catalog.Name, Vendors.Name, I1.CategoryId, I1.PackedCode, CrossRefs.PackedCode, 1
        from Items I1 
        join CrossRefs on CrossRefs.ItemId = I1.ItemId
  ...
  begin
    ...
    insert @ItemTable ([ItemId], [CrossRefId], [CrossRefIdBid], [BidPrice], [GrossPrice], [CatalogPrice], [AwardId], [VendorId], [PricePlanId], [CatalogId], [VendorItemCode], [Alternate], [BidItemId], [ParentCatalogId], [ItemCode], [Description], [UnitId], [UnitCode], [Page], [CatalogYear], [DiscountRate], [Name], [VendorName], [CategoryId], [PackedItemCode], [PackedVendorItemCode], ItemMustBeBid )
      select I1.ItemId, CrossRefs.CrossRefId, null, CrossRefs.GrossPrice, CrossRefs.GrossPrice, CrossRefs.CatalogPrice, null, null, @PricePlanId, CrossRefs.CatalogId, CrossRefs.VendorItemCode, null, null, I1.ParentCatalogId, I1.ItemCode, dbo.uf_ItemDescription(I1.ItemId), Units.UnitId, Units.Code, CrossRefs.Page, CrossRefs.CatalogYear, null, null, null, I1.CategoryId, I1.PackedCode, CrossRefs.PackedCode, 1
        from Items I1 
        left outer join Units on Units.UnitId = I1.UnitId
...
Update @ItemTable
   ...
   (select top 1 CatalogId
     ...
     order by IB desc, BidPrice, BidItemId, CrossRefId
       ...
       ItemCode = (select Items.ItemCode from Items where items.itemid = it.itemid),
     ...
     where items.itemid = it.itemid
       ...
       UnitId = (select Items.UnitId from Items where items.itemid = it.itemid),
       UnitCode = (select Units.Code from Items join Units on Units.UnitId = Items.UnitId where items.itemid = it.itemid),
       BidPrice =
...
--       SortSeq = (select Items.SortSeq from Items where items.itemid = it.itemid),
       BidItemId =
...
Update @ItemTable
   ...
   (select top 1 CatalogId
     ...
     order by IB desc, BidPrice, BidItemId, CrossRefId
      ...
      left outer join dbo.Headings on Headings.HeadingId = Items.HeadingId  
      left outer join dbo.BookTypes on BookTypes.BookTypeId = Items.EditionId  
      left outer join EDSIQWebUser.Keywords Keywords on Keywords.KeyWordId = Items.KeywordId  
      left outer join dbo.Vendors on Vendors.VendorId = Items.VendorId  
     where items.itemid = it.itemid
       and Items.Active = 1
),
