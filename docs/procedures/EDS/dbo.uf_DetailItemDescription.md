...
_Generated on 2026-05-04T13:04:24.241Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_DetailItemDescription` |
| Kind | Function (scalar) |
| sys.objects.type | `FN` (SQL_SCALAR_FUNCTION) |
| Created | 2006-08-07 11:05:00 |
| Modified | 2015-09-01 11:54:21 |
| Encrypted | no |
...
| `dbo.vw_BidDescriptions` | VIEW |
| `dbo.vw_DetailDescriptionSBS` | VIEW |

## Definition

```sql
CREATE   function [dbo].[uf_DetailItemDescription] (@pRequisitionId int, @pItemId int)  
returns varchar(1024)  
