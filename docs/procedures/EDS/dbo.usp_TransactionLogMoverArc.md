# Procedure: `dbo.usp_TransactionLogMoverArc`

_Generated on 2026-05-04T13:07:57.813Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `usp_TransactionLogMoverArc` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2026-04-26 12:30:41 |
| Modified | 2026-04-26 13:18:46 |
| Encrypted | no |
...
| `TransactionLogCF_Arc` | USER_TABLE |  |
...
*/
while @KeepLooping = 1 and @LoopCount > 0
begin
begin transaction
if @@ROWCOUNT = 0
begin
	...
	select top 5000 SysId, RequestStart, RequestEnd, SessionId, TargetServer, URL, Headers, Content, Method, Protocol
	  from TransactionLogCF_Arc tl with (nolock)
...
begin
	Delete tl
	  from TransactionLogCF_Arc tl with (rowlock, updlock)
	  join @IdsToRemove idr on idr.SysId = tl.SysId
end
else
begin
