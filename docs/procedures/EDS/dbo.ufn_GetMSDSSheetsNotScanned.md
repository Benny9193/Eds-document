...
_Generated on 2026-05-04T13:04:00.675Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `ufn_GetMSDSSheetsNotScanned` |
| Kind | Function (table-valued) |
| sys.objects.type | `TF` (SQL_TABLE_VALUED_FUNCTION) |
| Created | 2017-04-19 16:00:36 |
| Modified | 2017-04-19 16:00:36 |
| Encrypted | no |
...
```sql
create function [dbo].[ufn_GetMSDSSheetsNotScanned] (@pDistrictId int)
