...
_Generated on 2026-05-04T13:04:00.303Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `sp_BidCompareSame` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2019-11-20 17:16:32 |
| Modified | 2019-11-20 17:18:43 |
| Encrypted | no |
...
*/
CREATE procedure [dbo].[sp_BidCompareSame] @pBidOld int, @pBidNew int as
...
select bn.ItemCode, bn.Description, isnull(bo.Alternate,'') [Old Alternate], isnull(bn.Alternate,'') [New Alternate], isnull(bo.BidPrice,0) OldPrice, isnull(bn.BidPrice,0) NewPrice, isnull(bn.BidPrice,0) - isnull(bo.BidPrice,0) Diff, isnull(bn.BidRequest,0) BidRequest, isnull(bn.BidRequest,0) * (isnull(bn.BidPrice,0) - isnull(bo.BidPrice,0)) Extended, isnull(cast(bo.BidHeaderId as varchar),'') OldBid, bn.BidheaderId NewBid
  from #BidComp bn
