# Procedure: `dbo.sp_CreateOrderBook`

_Generated on 2026-05-04T14:49:07.248Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `sp_CreateOrderBook` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2004-08-04 11:19:28 |
| Modified | 2021-06-01 16:01:37 |
| Encrypted | no |
...
```sql
--exec [sp_CreateOrderBookTest] 10885, 0
create   procedure [dbo].[sp_CreateOrderBook] @pBidHeaderId int, @pAwardId int as
