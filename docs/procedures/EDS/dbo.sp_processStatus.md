...
_Generated on 2026-05-04T13:43:18.887Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `sp_processStatus` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2008-02-20 12:16:42 |
| Modified | 2009-06-15 10:16:41 |
| Encrypted | no |
...
```sql
--sp_ProcessStatus 65
CREATE procedure [dbo].[sp_processStatus] @pSpid int
as
declare @spid int,
	@Cmd varchar(1024),
...
Update #ProcessTable
   set State = case 
       ...
       SortKey = case
                 ...
                 convert(varchar(32),last_batch,121) +
