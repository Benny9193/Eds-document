...
| Caller | Type |
|--------|------|
| `dbo.BidProjectAveragePO` | VIEW |

## Definition

```sql
--select * from BidImports where BidHeaderId = 11495 and VendorId = 8824
--select * from BidResults where BidImportId = 88384 and ItemBidType > ''


CREATE function [dbo].[uf_BidProjectAveragePOReq] (@pBidHeaderId int, @pRequisitionId int)
returns table 
as
return(
