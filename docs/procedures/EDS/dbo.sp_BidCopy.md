# Procedure: `dbo.sp_BidCopy`

_Generated on 2026-05-04T13:07:57.359Z_
...
| Created | 2010-09-15 23:00:35 |
| Modified | 2022-12-08 11:43:22 |
| Encrypted | no |
...
```sql
CREATE   procedure [dbo].[sp_BidCopy] @pSourceBidId int, @pCopies int as
