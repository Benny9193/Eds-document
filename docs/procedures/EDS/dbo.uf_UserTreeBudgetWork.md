# Function: table-valued: `dbo.uf_UserTreeBudgetWork`

_Generated on 2026-05-04T14:49:07.436Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_UserTreeBudgetWork` |
| Kind | Function (table-valued) |
| sys.objects.type | `TF` (SQL_TABLE_VALUED_FUNCTION) |
| Created | 2013-11-07 12:49:41 |
| Modified | 2013-11-07 13:15:52 |
| Encrypted | no |
...
```sql
CREATE function [dbo].[uf_UserTreeBudgetWork] (@pBudgetId int, @pSchoolId int = 0, @pApproverId int = 0)
