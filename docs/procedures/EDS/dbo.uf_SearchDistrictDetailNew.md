# Function: table-valued: `dbo.uf_SearchDistrictDetailNew`

_Generated on 2026-05-04T13:04:00.639Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_SearchDistrictDetailNew` |
| Kind | Function (table-valued) |
| sys.objects.type | `TF` (SQL_TABLE_VALUED_FUNCTION) |
| Created | 2008-02-26 20:22:23 |
...
CREATE function dbo.uf_SearchDistrictDetailNew (@pRequisitionId int, @pHeadingId int) 
...
begin
  ...
  insert @LYDistrict (ItemId, BidHeaderId)
    select Items.ItemId, (select BidHeaderId from Requisitions where RequisitionId = @pRequisitionId)
