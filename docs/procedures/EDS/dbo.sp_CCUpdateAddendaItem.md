...
_Generated on 2026-05-04T13:43:18.735Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `sp_CCUpdateAddendaItem` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2009-12-04 14:59:29 |
| Modified | 2014-10-07 17:53:22 |
| Encrypted | no |
...
| 14 | `@pDetailId` | IN | int |  |
| 15 | `@sessionID` | IN | int |  |
| 16 | `@pVendorToSupplyManufacturer` | IN | tinyint |  |
...
```sql
CREATE procedure [dbo].[sp_CCUpdateAddendaItem] @pHeadingId int, @pKeywordId int, @pDescription varchar(1024), 
                                      ...
                                      @pRequisitionId int, @pQuantity int, @pDetailId int, @sessionID int, @pVendorToSupplyManufacturer tinyint = null
as
declare @ItemId int,
	@BidItemId int,
	@UnitCode varchar(16),
  ...
  begin  
    ...
    Update Items
       set HeadingId = @pHeadingId,
           ...
           , VendorToSupplyManufacturer = @pVendorToSupplyManufacturer
