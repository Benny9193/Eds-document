# Function: table-valued: `dbo.uf_PODetailSummary`

_Generated on 2026-05-04T13:04:00.606Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_PODetailSummary` |
| Kind | Function (table-valued) |
| sys.objects.type | `TF` (SQL_TABLE_VALUED_FUNCTION) |
| Created | 2004-09-30 10:03:48 |
...
```sql
CREATE                function dbo.uf_PODetailSummary ( @pDistrictId int, @pBudgetId int, @pPONumber varchar(30))
...
/*           dbo.Detail.ItemCode, */
           ...
           min(dbo.Category.[Name]) CategoryName, min(char(dbo.Category.EDSId)) CategoryCode, min(isnull(dbo.ShipLocations.LocationCode,'')), dbo.Detail.SortSeq,
      ...
      join dbo.PO on dbo.PO.POId = dbo.Detail.POId
     ...
     where dbo.District.DistrictId = @pDistrictId
       ...
       and dbo.PO.PONumber = rtrim(@pPONumber)
