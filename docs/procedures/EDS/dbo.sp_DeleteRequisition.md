# Procedure: `dbo.sp_DeleteRequisition`

_Generated on 2026-05-04T14:49:07.259Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `sp_DeleteRequisition` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2001-12-13 12:59:39 |
| Modified | 2012-08-31 09:33:51 |
| Encrypted | no |
...
```sql
CREATE      procedure [dbo].[sp_DeleteRequisition] @pSessionId int, @pRequisitionId int, @rStatus int output AS
