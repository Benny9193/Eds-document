# Function: scalar: `dbo.uf_SetSortSeq3`

_Generated on 2026-05-04T13:43:19.107Z_
...
| Created | 2011-11-28 10:22:57 |
| Modified | 2011-11-28 10:22:57 |
| Encrypted | no |
| Returns | varchar(255) |
...
```sql
create function [dbo].[uf_SetSortSeq3] (@pSource varchar(255)) returns varchar(255) with schemabinding AS
begin
