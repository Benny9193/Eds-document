# Function: scalar: `dbo.uf_DetailItemDescriptionNoExtraNH`

_Generated on 2026-05-04T13:04:24.242Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `uf_DetailItemDescriptionNoExtraNH` |
| Kind | Function (scalar) |
| sys.objects.type | `FN` (SQL_SCALAR_FUNCTION) |
| Created | 2015-03-06 13:20:20 |
| Modified | 2015-09-01 11:53:30 |
| Encrypted | no |
...
```sql
CREATE function [dbo].[uf_DetailItemDescriptionNoExtraNH] (@pRequisitionId int, @pItemId int)  
returns varchar(1024)  
