...
_Generated on 2026-05-04T14:49:08.552Z_
...
|----------|-------|
| Schema | `dbo` |
| Name | `sp_PostCatalogNew` |
| Kind | Procedure |
| sys.objects.type | `P` (SQL_STORED_PROCEDURE) |
| Created | 2018-12-16 21:20:38 |
| Modified | 2023-02-14 15:58:21 |
| Encrypted | no |
...
```sql
create   PROCEDURE [dbo].[sp_PostCatalogNew] @pCatalogId int as
...
if @ImportFormat != 4
begin
	Raiserror(51000,16,1,'Catalog Import Format not a 4')
	return
end
